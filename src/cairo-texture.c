...
static void
phoc_cairo_texture_constructed (GObject *obj)
{
  PhocCairoTexture *self = PHOC_CAIRO_TEXTURE (obj);
  ...
  self->texture = wlr_texture_from_buffer (phoc_renderer_get_wlr_renderer (renderer), &self->buffer);
}


static void
phoc_cairo_texture_finalize (GObject *obj)
{
  PhocCairoTexture *self = PHOC_CAIRO_TEXTURE (obj);
